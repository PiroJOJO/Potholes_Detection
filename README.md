...
Следовательно, для дальнейшей доработки проекта необходимо найти больше данных именно с ямами, а не трещинами (чтобы уравновесить с числом вытянутых боксов) + донабрать при необходимости изображений (если ТЗ допускает возможность довольно близкую съемку), где требуемые объекты имеют большие боксы.
